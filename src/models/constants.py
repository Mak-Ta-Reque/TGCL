...
p7 = "Classify the image as either [concept] or No [concept] based on its content. Use exactly the word [concept] -- not a synonym -- in your answer. Return only the predicted label."
